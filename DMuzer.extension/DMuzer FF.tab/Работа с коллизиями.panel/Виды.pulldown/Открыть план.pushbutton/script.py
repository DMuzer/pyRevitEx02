...
st_str = """
***************************************************************
*** Открыть план вид коллизии
*** D:\18_проектирование\pyRevitExtension\DMuzer.extension\DMuzer FF.tab\Работа с коллизиями.panel\Открыть план.pushbutton — копия (4)\script.py
***************************************************************

***************************************************************
"""
print(st_str)
#UI.TaskDialog.Show("DMuzer-скрипт", "Открыть план вид коллизии")
