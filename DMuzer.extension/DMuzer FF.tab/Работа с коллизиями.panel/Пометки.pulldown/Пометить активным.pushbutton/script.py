...
***************************************************************
*** Пометить активным
*** D:\18_проектирование\pyRevitExtension\DMuzer.extension\DMuzer FF.tab\Работа с коллизиями.panel\Пометить активным.pushbutton\script.py
***************************************************************

***************************************************************
"""
#print(st_str)
#UI.TaskDialog.Show("Сообщение", "Функция активным")
def setProcessed(collision) :
    ...
    tr.Start()
    try :
        collision.LookupParameter("О_Примечание").Set("active")
        for view in views :
